...
def generate_launch_description():
    ...
    # 绿灯识别
    green_detector_node = ComposableNode(
        package='green_detector', 
        plugin='fyt::auto_aim::GreenDetectorNode',
        name='green_detector',
    ...
    green_solver_node = Node(
        ...
        output='both',
        emulate_tty=True,
        parameters=[get_params('green_solver')],
        ros_arguments=[],
    )
    ...
    cam_detector_node = get_camera_detector_container(green_detector_node)
